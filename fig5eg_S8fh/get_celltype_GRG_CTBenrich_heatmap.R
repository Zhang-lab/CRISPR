...
#    pdf(paste0("heatmap_", Days[i], "_CTBenrich_polish.pdf"), width=2.5, height=8 );
    pdf(paste0("heatmap_", Days[i], "_CTBenrich_polish.pdf"), width=7, height=8 );
...
#    pheatmap(log2_rowMeans_data2, cluster_cols=F, angle_col=45, main=paste0(gsub("D","",Days[i]), " d.p.f (n=", nrow(log2_rowMeans_data2),")"), fontsize_row=0.9999)
