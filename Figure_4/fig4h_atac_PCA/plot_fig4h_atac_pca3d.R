...
data<- read.table("atac_norm_result_k1", header=T, row.names=1)
...
htmlwidgets::saveWidget(as_widget(x), selfcontained = F, paste0("/home/shuhua/Public_html/theunissen_CRISPR/hTSC_EVT_STB_atac_rna_pca/atac_pca_k1_by_",field_title,".html") )
}
#############===end generate_3Dpca
